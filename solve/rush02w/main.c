...
int	ft_atoi(char *string, int start, int end)
{
	int	i;
	int	res;
...
int	main (int argc, char *argv[])
{
	...
	t_digit_dict *t_digit_head;
	t_digit_head = get_digit_dict();

	if (argc == 2)
	{
		convert_string(argv[1], t_head, t_digit_head);
	}
}
