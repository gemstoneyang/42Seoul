...
/*   Updated: 2022/12/29 22:22:16 by wonyang          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
int	philo_take_fork(t_philo *philo, t_fork *fork)
{
	...
	fork->status = 0;
	print_log(philo, get_time(), "has taken a fork", 4);
	return (0);
}
...
int	philo_eat(t_philo *philo)
{
	...
	print_log(philo, philo->last_eat_time, "is eating", 2);
...
{
	print_log(philo, get_time(), "is sleeping", 5);
...
{
	print_log(philo, get_time(), "is thinking", 3);
	return (0);
}
